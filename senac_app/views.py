...
from .forms import ProfileForm, ContatoForm
import os

def home(request):
    return render(request, 'senac_app/home.html')

def cursos(request):
    cursos = Curso.objects.filter(disponivel=True)
    return render(request, 'senac_app/cursos.html', {'cursos': cursos})
...
def contatos(request):
    ...
    return render(request, 'senac_app/contatos.html')
...
def upload_profile(request):
    if request.method == 'POST':
        ...
        form = ProfileForm()
    return render(request, 'senac_app/upload_profile.html', {'form': form})
...
def contato(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('senac_app:contatos')
    else:
        form = ContatoForm()
    ...
    return render(request, 'senac_app/contatos.html', context)
